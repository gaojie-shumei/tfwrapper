from tfwrapper.basev2.wrapperv2.entity import InputFeatures, InputSample, FeatureTypingFunctions
...
class GeneralDataProcessor(BaseDataProcessor):
    def __init__(self,input_size:int,output_size:int=None):
        ...
        try:
            ...
            name_to_features = {
                "x":tf.FixedLenFeature(shape=input_size,dtype="float"),
                "y":tf.FixedLenFeature(shape=output_size,dtype=tf.int64),
